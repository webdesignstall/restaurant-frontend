                ...
                <div className='col-span-3'>
                    <div className='md:grid flex space-y-2 md:space-y-0 flex-col md:grid-cols-2 gap-x-10 gap-y-6'>
                        <div>
                            ...
                            <input className='w-full rounded-2xl py-2 px-4' placeholder='First Name' type="text" />
                        </div>
                        <div>
                            <label className='text-white font-medium text-lg pb-2 block' htmlFor="">Last name</label>
                            <input className='w-full rounded-2xl py-2 px-4' placeholder='Last name' type="text" />
                        </div>
                        <div>
                            <label className='text-white font-medium text-lg pb-2 block' htmlFor="">Email</label>
                            <input className='w-full rounded-2xl py-2 px-4' placeholder='Email' type="text" />
                        </div>
                        <div>
                            <label className='text-white font-medium text-lg pb-2 block' htmlFor="">Phone number</label>
                            <input className='w-full rounded-2xl py-2 px-4' placeholder='Phone number' type="text" />
                        </div>
                        <div className='col-span-2'>
                            <label className='text-white font-medium text-lg pb-2 block' htmlFor="">Preferred Restaurant Location</label>
