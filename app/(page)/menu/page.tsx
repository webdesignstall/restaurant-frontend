  ...
  return (
    <div>
      <div className='pb-20 pt-4'>
        ...
        <div>
          <div className='sm:grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 max-w-screen-xl m-auto px-4 flex flex-col '>
            {
        ...
        <div className='py-20'>
          <div className='md:grid grid-cols-5 gap-x-20 max-w-7xl m-auto px-8 justify-center items-center flex flex-col'>
            ...
            <div className='col-span-2 flex flex-col justify-center items-center md:justify-start md:items-start'>
              <div className='py-4'>
                <p className='lg:text-6xl text-5xl text-center md:text-left font-bebas leading-none font-bold text-primary md:pb-4'>Where Culinary Expertise, Ingredient Obsession, And Nutritional Wisdom Merge</p>
              </div>
              <div className='pb-8'>
              ...
              <div>
                <Button className='rounded-3xl px-8 text-xl'>
                  Our Story
                </Button>
              </div>
            </div>
